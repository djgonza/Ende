...
{ 
    ...
    private void crearHabitaciones() 
    {
        ...
        lampara    = new Elemento("Lamapara de aceite", 2000);
        ...
        exterior.setElemento(llave);
        cine.setElemento(mapa);
        bar.setElemento(agua);
        laboratorio.setElemento(microscopio);
        despacho.setElemento(cofre);
        sotano.setElemento(lampara);
        calabozo.setElemento(fuego);
