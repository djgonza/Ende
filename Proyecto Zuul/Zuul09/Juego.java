...
{ 
    ...
    private void crearHabitaciones() 
    {
        ...
        cofre       = new Elemento("Cofre", "Cofre del tesoro", 40000);   
        mapa        = new Elemento("Mapa", "Mapa del tesoro", 500);
        llave       = new Elemento("Llave", "Llave del cofre", 100);
        agua        = new Elemento("Agua", "Agua envenenada", 5000);
        lampara    = new Elemento("Luz", "Lampara de aceite", 2000);
        microscopio = new Elemento("Micro", "Microscopio", 50);
        fuego      = new Elemento("Fuego", "Una llamarada de Charizard", 1);
    ...
    {     
        ...
        else if (palabra.equals("tomar")) jugador.tomar(orden);
        else if (palabra.equals("dejar")) jugador.dejar(orden);
